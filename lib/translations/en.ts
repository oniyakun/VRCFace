export const en = {
  ...
  profile: {
    ...
    noFollowersOwn: 'No followers yet',
    noFollowersOther: 'This user has no followers yet',
    noFollowing: 'No following',
    noFollowingOwn: 'Not following anyone yet',
    noFollowingOther: 'This user is not following anyone yet',
    viewProfile: 'View Profile',
    followedAt: 'Followed on',
    private: 'Private',
    views: 'Views',
    likes: 'Likes',
    edit: 'Edit',
